...
class MentorApplicationfoForm_step5(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        time_slots_choices = (
                     ...
                     ('T_5:00-5:50PM',      'T 5:00-5:50PM'),
                     ('T_6:00-6:50PM',      'T 6:00-6:50PM'),
                     ('W_10:00-10:50AM',    'W 10:00-10:50AM'),
                     ('W_10:00-11:50AM',    'W 10:00-11:50AM'),
                     ('W_11:00-11:50AM',    'W 11:00-11:50AM'),
                     ('W_12:00-12:50PM',    'W 12:00-12:50PM'),
                     ('W_12:00-1:50PM',     'W 12:00-1:50PM'),
                     ('W_1:00-1:50PM',      'W 1:00-1:50PM'),
                     ('W_2:00-3:50PM',      'W 2:00-3:50PM'),
                     ('W_4:00-4:50PM',      'W 4:00-4:50PM'),
                     ('W_4:00-5:50PM',      'W 4:00-5:50PM'),
                     ('W_6:00-7:50PM',      'W 6:00-7:50PM'),
                     ('R_4:00-5:50PM',      'R 4:00-5:50PM'),
                     ('R_6:00-7:50PM',      'R 6:00-7:50PM'),
        )
