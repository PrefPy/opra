...
function UICheckboxes(){
	if(document.getElementById("twocol_checkbox").checked || document.getElementById("onecol_checkbox").checked ||document.getElementById("slider_checkbox").checked ||document.getElementById("star_checkbox").checked||document.getElementById("yesno_checkbox").checked){
		return true;
	}
